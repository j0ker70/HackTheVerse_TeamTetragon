...
public class Workers_Deleivery_Order_List extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_workers__deleivery__order__list);
        worker_delivery_OrderList();
    }

    private void worker_delivery_OrderList() {
        ListView listView = findViewById(R.id.Workers_delivery_orders_ListView_Id);
        ...
        CustomAdapter customAdapter = new CustomAdapter(Workers_Deleivery_Order_List.this,
...
//            Toast.makeText(Order_List_for_Workers_Activity.this, orderID[position], Toast.LENGTH_SHORT).show();
            ...
            AlertDialog.Builder OTP_Checker_Builder = new AlertDialog.Builder(Workers_Deleivery_Order_List.this);
                ...
                public void onClick(View v) {
                    ...
                    if ( !input_form_user.isEmpty()) {
                        ...
                        if(input_form_user.equals(corresponding_order_OTP)) {
                            ...
                            Toast.makeText(Workers_Deleivery_Order_List.this, "OTP matched", Toast.LENGTH_SHORT).show();
                            OTP_CHECKER_AlertDialog.dismiss();
                        }
                        else
                            Toast.makeText(Workers_Deleivery_Order_List.this, "Unsucesful ! You must have to provide OTP that was given when you ordered the product", Toast.LENGTH_SHORT).show();

                    }
                    else if (input_form_user.isEmpty())
                        Toast.makeText(Workers_Deleivery_Order_List.this, "You must have to provide OTP that was given when you ordered the product", Toast.LENGTH_SHORT).show();
